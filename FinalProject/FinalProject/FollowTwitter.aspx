...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageName" runat="server">
      <p><asp:Label ID="lblPageName" runat="server" Text="About Us"></asp:Label></p>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphTop" runat="server">
   ...
   <div class="aboutUs">
    ...
    <!-- add contact information and twitter login  -->
      <asp:HyperLink ID="test" NavigateUrl="https://twitter.com/TreelineAbove" Text="Follow @TreelineAbove" runat="server"></asp:HyperLink>
    </div>
</asp:Content>
